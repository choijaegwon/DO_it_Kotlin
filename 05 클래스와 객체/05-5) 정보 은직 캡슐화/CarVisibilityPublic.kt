...
open class Car protected constructor(_year: Int, _model: String, _power: String, _wheel: String){ // 1번
    ...
    class Driver(_name: String, _license: String) { // 2번
...
class Burglar(){
    fun steal(anycar: Any){
        if (anycar is Tico) { // 4번 인자가 Tico의 객체일 때
